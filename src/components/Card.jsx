export default function Card(props) {
  ...
  return (
    <div className="flex flex-row flex-grow bg-whiteDetail rounded-3xl">
      <div className="w-[250px] h-80 bg-center bg-cover rounded-3xl" style={{ backgroundImage: `url(${cat.url})` }}>

      </div>
      <div className="flex flex-col  flex-grow justify-between p-6">
        <div className="flex flex-col w-[180px] gap-10">
          <h1 className="font-bold text-xl">{cat.name}</h1>
          <ul className="font-extralight text-xl list-item px-8">
